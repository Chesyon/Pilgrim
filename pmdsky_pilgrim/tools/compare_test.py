...
def main(vanilla_eu_name: str, vanilla_na_name: str, mod_eu_name: str):
    ...
    archi_added, archi_modified_eu_na_identical, archi_modified_eu_na_different, archi_modified_na_missing = create_lists(eu, mod_eu, na)
    print("The following files were added for Archipelago: " + str(archi_added) + "\n")
    print("The following files were modified for Archipelago, are present in NA, and vanilla EU/NA files match: " + str(archi_modified_eu_na_identical) + "\n")
    print("The following files were modified for Archipelago, are present in NA, but vanilla EU/NA files do NOT match: " + str(archi_modified_eu_na_different) + "\n")
    print("The following files were modified for Archipelago, but are missing in NA: " + str(archi_modified_na_missing) + "\n")
